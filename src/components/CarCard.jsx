  ...
  return (
    <div className="car-card">
      ...
      <div className="car-info">
        <h2>
          {car.Prod_year} {car.Manufacturer} {car.Model}
        </h2>
        <h3>
          ${Math.abs(car.Price).toLocaleString()} |{" "}
          {parseInt(car.Mileage).toLocaleString()} MI
        </h3>
        <p1>
          {car.Color} {car.Category} | {car.Doors} Doors | {car["Drive wheels"]}
          -Wheel Drive
        </p1>
        <p1>{car.Airbags} Airbags</p1>
        <p1>
          {car.Cylinders} Cylinders | {car["Fuel type"]} |{" "}
          {car["Engine volume"]} | {car["Gear box type"]}{" "}
        </p1>
